...
public class QRCodeFactory {
     ...
     * @param targetDir         二维码保存的目标目录
     * @param logUri            二维码中间logo的地址
     * @param size              用于设定图片大小（可变参数，宽，高）
     * @throws IOException
     * @throws WriterException
     */
    public void creatQrImage(String content, String format, String fileName,
            String targetDir, String logUri, int... size) throws IOException,
            WriterException {
        ...
        // 生成二维码图片文件
        File outputFile = new File(dirFile.getPath(), fileName);
