package com.dawnwing.framework.supers.dao.api;
...
public interface IBasalDao<T> {
	 ...
	 *            不定参数数组
	 */
	public abstract Integer querySql(String sqlString, Object... values);
	 ...
	 * @return List
	 */
	public List<T> findListBySql(final String sql, final RowMapper<T> map,
			final Object... values);
	 ...
	 */
	public abstract SimplePage<T> findPageByFetchedHql(String hql,
